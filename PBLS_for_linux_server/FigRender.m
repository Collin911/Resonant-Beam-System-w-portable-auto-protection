...
set(gca,'position',[0.075 0.085 0.92 0.9])

hold on

InputPowerP1 = plot(xAxis, ThreshP1, 'LineStyle','-.','Marker', '^','MarkerSize',10,'LineWidth',2.2,'color', [231 76 60]./255);
% InputPowerPm1 = plot(xAxis, ThreshPm1, 'LineStyle','-','Marker', 'v','MarkerSize',5,'LineWidth',2.2,'color', [130 176 210]./255);
InputPowerNP1 = plot(xAxis, ThreshNP1, 'LineStyle','--','Marker', 'Diamond','MarkerSize',10,'LineWidth',2.2,'color', [241 196 15]./255);

InputPowerP = plot(xAxis, ThreshP, 'LineStyle','-.','Marker', '^', 'MarkerSize',10,'LineWidth',2.2, 'color', [125 60 152]./255);
InputPowerPm = plot(xAxis, ThreshPm, 'LineStyle','-','Marker', 'v','MarkerSize',10,'LineWidth',2.2, 'color', [31 97 141]./255);
InputPowerNP = plot(xAxis, ThreshNP, 'LineStyle','-','Marker', 'Diamond','MarkerSize',10,'LineWidth',2.2, 'color', [243 156 18]./255);
...
box on
grid on
legend( ' d=1m, $\tilde{P}_{\rm thresh}$', ' d=1m, ${P_{\rm thresh}}$', ...
    ' d=1.5m, $\tilde{P}_{\rm thresh}$',' d=1.5m, $\mathcal{M}\{\tilde{P}_{\rm thresh}\}$', ' d=1.5m, ${P_{\rm thresh}}$', ...
     'Interpreter', 'latex')
...
hold on
InputPowerP1 = plot(xAxis, ThreshP1, 'LineStyle','-.','Marker', '^','MarkerSize',5,'LineWidth',2.2,'color', [231 76 60]./255);
InputPowerPm1 = plot(xAxis, ThreshPm1, 'LineStyle','-','Marker', 'v','MarkerSize',5,'LineWidth',2.2,'color', [52 152 219]./255);
InputPowerNP1 = plot(xAxis, ThreshNP1, 'LineStyle','--','Marker', 'Diamond','MarkerSize',5,'LineWidth',2.2,'color', [241 196 15]./255);

InputPowerP = plot(xAxis, ThreshP, 'LineStyle','-.','Marker', '^','MarkerSize',5,'LineWidth',2.2,'color', [142 68 173]./255);
InputPowerPm = plot(xAxis, ThreshPm, 'LineStyle','-','Marker', 'v','MarkerSize',5,'LineWidth',2.2,'color', [31 97 141]./255);
InputPowerNP = plot(xAxis, ThreshNP, 'LineStyle','--','Marker', 'Diamond','MarkerSize',5,'LineWidth',2.2,'color', [243 156 18]./255);
...
legend(' d=3m, $\tilde{P}_{\rm thresh}$',' d=3m, $\mathcal{M}\{\tilde{P}_{\rm thresh}\}$', ' d=3m, ${P_{\rm thresh}}$', ...
    ' d=5m, $\tilde{P}_{\rm thresh}$',' d=5m, $\mathcal{M}\{\tilde{P}_{\rm thresh}\}$', ' d=5m, ${P_{\rm thresh}}$', 'Interpreter', 'latex', 'Location', 'North');
...
hold on
InputPowerP = plot(xAxis, ThreshP1, 'LineStyle','-.','MarkerSize',5,'LineWidth',2.2, 'color', [231 76 60]./255);
InputPowerPm = plot(xAxis, ThreshPm1, 'LineStyle','-','MarkerSize',5,'LineWidth',2.2, 'color', [52 152 219]./255);
InputPowerNP = plot(xAxis, ThreshNP1, 'LineStyle','--','MarkerSize',5,'LineWidth',2.2, 'color', [243 156 18]./255);
...
box on
grid on
legend( ' $\tilde{P}_{\rm thresh}$',' $\mathcal{M}\{\tilde{P}_{\rm thresh}\}$', ' ${P_{\rm thresh}}$', 'Interpreter', 'latex')
...
InputPowerP_micro = plot(xAxis_micro, ThreshP_micro, 'LineStyle','-.','MarkerSize',5,'LineWidth',1.8, 'color', [231 76 60]./255);
InputPowerPm_micro = plot(xAxis_micro, ThreshPm_micro, 'LineStyle','-','MarkerSize',5,'LineWidth',1.8, 'color', [52 152 219]./255);
InputPowerNP_micro = plot(xAxis_micro, ThreshNP_micro, 'LineStyle','--','MarkerSize',5,'LineWidth',1.8, 'color', [243 156 18]./255);
...
EffPm1 = plot(xAxis, V_pbm1, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [52 152 219]./255);
EffNP1 = plot(xAxis, V_np1, 'LineStyle','--','Marker', 'Diamond','MarkerSize',10,'LineWidth',2.2, 'color', [241 196 15]./255);

EffP = plot(xAxis, V_pb, 'LineStyle','-.','Marker', 'v','MarkerSize',10,'LineWidth',2.2, 'color', [142, 68, 173 ]./255);
EffPm = plot(xAxis, V_pbm, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [31 97 141]./255);
EffNP = plot(xAxis, V_np, 'LineStyle','--','Marker', 'Diamond','MarkerSize',10,'LineWidth',2.2, 'color', [243 156 18]./255);
legend(' d=1m, $\tilde{V_{rt}}$', ' d=1m, ${V_{rt}}$', ...
    ' d=1.5m, $\tilde{V_{rt}}$',' d=1.5m, $\mathcal{M}\{\tilde{V_{rt}}\}$', ' d=1.5m, ${V_{rt}}$', 'Interpreter', 'latex');
% 
ylabel('Transfer Efficiency','Interpreter','latex'); 
xlim([0 75])
box on
...
RPm1 = plot(xAxis, ERm1, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [52 152 219]./255);

RP = plot(xAxis, ER, 'LineStyle','-.','Marker', 'v','MarkerSize',10,'LineWidth',2.2, 'color', [142, 68, 173 ]./255);
RPm = plot(xAxis, ERm, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [31 97 141]./255);
RNP = plot(xAxis, Ros, 'LineStyle','--','MarkerSize',10,'LineWidth',2.6, 'color', [39 174 96]./255);
...
xlabel('Angle [ ° ]','Interpreter','latex');
ylabel('Reflectance','Interpreter','latex'); 
legend(' d=1m, $\tilde{R_r}$',...
    ' d=1.5m, $\tilde{R_r}$',  ' d=1.5m, $\mathcal{M}\{\tilde{R_r}\}$', ...
     ' $R_r$', 'Interpreter', 'latex');
% 
box on
grid on
...
EffPm = plot(xAxis, V_pbm, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [31 97 141]./255);
EffNP = plot(xAxis, V_np, 'LineStyle','--','Marker', 'Diamond','MarkerSize',10,'LineWidth',2.2, 'color', [243 156 18]./255);
legend(' d=3m, $\tilde{V_{rt}}$',' d=3m, $\mathcal{M}\{\tilde{V_{rt}}\}$', ' d=3m, ${V_{rt}}$', ...
    ' d=5m, $\tilde{V_{rt}}$',' d=5m, $\mathcal{M}\{\tilde{V_{rt}}\}$', ' d=5m, ${V_{rt}}$', 'Interpreter', 'latex', 'Location', 'South');
xlim([-3.5 3.5])
ylabel('Transfer Efficiency','Interpreter','latex'); 
box on
grid on
...
RP = plot(xAxis, ER, 'LineStyle','-.','Marker', 'v','MarkerSize',10,'LineWidth',2.2, 'color', [142, 68, 173 ]./255);
RPm = plot(xAxis, ERm, 'LineStyle','-','Marker', '^','MarkerSize',10,'LineWidth',2.2, 'color', [31 97 141]./255);
RNP = plot(xAxis, repelem(Ro, length(ER)), 'LineStyle','--','MarkerSize',10,'LineWidth',2.6, 'color', [39 174 96]./255);
...
EffP = plot(xAxis, V_pb1, 'LineStyle','-.','MarkerSize',5,'LineWidth',2.2, 'color', [231, 76, 60]./255);%, [200 36 35]./255);
EffPm = plot(xAxis, V_pbm1, 'LineStyle','-','MarkerSize',5,'LineWidth',2.2, 'color', [52, 152, 219]./255);%, [40 120 181]./255);
EffNP = plot(xAxis, V_np1, 'LineStyle','--','MarkerSize',5,'LineWidth',2.2, 'color', [243, 156, 18]./255);%, [237 177 32]./255);
legend(' $\tilde{V_{\rm rt}}$',' $\mathcal{M}\{\tilde{V_{\rm rt}}\}$', ' ${V_{\rm rt}}$', 'Interpreter', 'latex');
ylabel('Transfer Efficiency','Interpreter','latex'); 
xlim([0.5 8])
set(gca,'xtick',[0.5 1 2 3 4 5 6 7 8])
box on
...
RP = plot(xAxis, ER1, 'LineStyle','-.','MarkerSize',5,'LineWidth',2.2, 'color', [231, 76, 60]./255);
RPm = plot(xAxis, ERm1, 'LineStyle','-','MarkerSize',5,'LineWidth',2.2, 'color', [52, 152, 219]./255);
...
RNP = plot(xAxis, repelem(Ro, length(ER1)), 'LineStyle','--','MarkerSize',5,'LineWidth',2.2, 'color', [243, 156, 18]./255);
...
xlabel('Distance [ m ]','Interpreter','latex');
ylabel('Reflectance','Interpreter','latex'); 
legend(' $\tilde{R_{r}}$',' $\mathcal{M}\{\tilde{R_{r}}\}$', ' ${R_{r}}$', 'Interpreter', 'latex');
